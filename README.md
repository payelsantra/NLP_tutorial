...
The file BERT_training.ipynb contains the code for finetuning BERT and SciBERT. Models can be loaded and directly used for inference. The model weights for BERT and SciBERT after finetuning on SST2 dataset can be downloaded from the following links -
...
## Results
The table presents results comparing the performance of BERT and SciBERT models without finetuning and after finetuning for 10 epochs on SST2 dataset. 
